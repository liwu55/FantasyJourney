...
public class ComboSystem : MonoBehaviour
{
    ...
    private void CheckSkill01()
    {
        if (GetKeyCodeDown((int) EKeyName.normalAttack) && skillCombo_01 < 3)
        {
            //播放动画
    ...
    private void CheckSkill02()
    {
        ...
        if (skillCombo_02 > 0)
        {
            ...
            if (skillCombo_02 == 2 && GetKeyCodeDown((int) EKeyName.rightMove))
                skillCombo_02 = 3;
            if (skillCombo_02 == 3 && GetKeyCodeDown((int) EKeyName.normalAttack))
                skillCombo_02 = 4;
        }
        if (skillCombo_02 == 4)
        {
